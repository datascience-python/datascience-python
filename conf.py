...
BLOG_AUTHOR = "Carlos Machel"  # (translatable)
BLOG_TITLE = "Data Science - Python"  # (translatable)
...
BLOG_DESCRIPTION = "Site para o grupo datascience-python do telegram"  # (translatable)
